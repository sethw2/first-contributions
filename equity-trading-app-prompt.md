...
| **Universe** | Liquid US large-caps + major ETFs (SPY, QQQ, sector ETFs) with a min average-dollar-volume filter | Liquidity kills slippage — the silent account-killer at this timeframe. No penny stocks, no illiquid names. |
